...
<template>
    <div class="space-y-16 pb-20">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-black/20">
                    <div class="space-y-2">
                        ...
                        <select v-model="selectedPosition"
                            ...
                            <option v-for="opt in positionOptions" :key="opt" :value="opt" class="bg-slate-900">{{ opt
                                }}</option>
                        </select>
                    </div>
                    <div class="space-y-2">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
                class="glass-card p-10 space-y-8 bg-gradient-to-br from-indigo-500/5 to-transparent group hover:border-emerald-500/30 transition-colors">
                ...
                <div class="flex items-center justify-center p-8 glass bg-black/40 rounded-2xl border border-white/5">
            ...
            <div class="glass-card p-10 space-y-8 group hover:border-purple-500/30 transition-colors">
                <h3 class="text-xl font-bold italic flex items-center gap-3 uppercase tracking-tighter text-white">
            ...
            <div class="glass-card p-10 space-y-8 group hover:border-amber-500/30 transition-colors">
                <h3 class="text-xl font-bold italic flex items-center gap-3 uppercase tracking-tighter text-white">
                    <Icon name="heroicons:users" class="text-amber-400" />
                    Rich Interaction
                </h3>
        ...
        <section class="space-y-6">
            ...
            <div class="code-window shadow-2xl shadow-indigo-500/5">
                ...
                <div class="p-8 font-mono text-sm leading-relaxed overflow-x-auto bg-slate-950/50">
                    <pre><span class="text-pink-500">import</span> { <span class="text-indigo-400">Tooltip</span> } <span
                ...
                <span class="text-white">{{ tooltipCodeExample }}</span>
            </pre>
                </div>
            </div>
        </section>
